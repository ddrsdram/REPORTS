<?php
namespace Reports\ByTypeAccrual\AccrualsForLS_OneRow_byHouse;
...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Ведомость о начислениях с фильтром по видам начисления (группировка по дому)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Ведомость о начислениях с фильтром по видам начисления (группировка по дому)";
