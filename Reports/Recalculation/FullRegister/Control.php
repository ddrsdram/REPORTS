<?php
namespace Reports\Recalculation\FullRegister;
...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Полный реестр справок(перерасчетов)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Полный реестр справок(перерасчетов)";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('RecalculationFullRegister.xlsx');
