<?php
namespace Reports\ForPopulation\InformationBillTSG;
...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Извещение ТСЖ";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Извещение ТСЖ";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('InformationBillTSG.xlsx');
