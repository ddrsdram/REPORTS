<?php
namespace Reports\ForPopulation\InformationBill_UK_2_na_LIST;
...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Извещение УК (2 на лист)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Извещение УК (2 на лист)";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('InformationBill_UK_2_na_LIST.xlsx');
