...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Ведомость о начислениях (расширенная) (группировка по дому)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Ведомость о начислениях по видам начислений (расширенная) (группировка по дому)";
