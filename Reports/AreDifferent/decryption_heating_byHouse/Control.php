...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Расшифровка начислений по отоплению По домам";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Расшифровка начислений по отоплению По домам";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('decryption_heating_byHouse.xlsx');
