...
class Control extends \Reports\reportControl
{
    function __construct($id_report)
    {
        ...
        $this->nameReport = 'Начисления по виду начисления "Текущий ремонт" с детализацией по домам за весь период';
        $this->extensionName = ".xlsx";
        $this->descriptionReport = 'Начисления по виду начисления "Текущий ремонт" с детализацией по домам за весь период';
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('accrualsFor_typeAccrual_ByHouse_AllPeriod.xlsx');
