...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Горячее водоснабжение форма для МКД (для Прокопьевского муниципального округа)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Горячее водоснабжение форма для МКД  (для Прокопьевского муниципального округа)";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('Hot_water_MKD.xlsx');
