...
class Control extends \Reports\reportControl
{
    ...
    function __construct($id_report)
    {
        ...
        $this->nameReport = "Отопление форма для частного сектора (для Прокопьевского муниципального округа)";
        $this->extensionName = ".xlsx";
        $this->descriptionReport = "Отопление форма для частного сектора (для Прокопьевского муниципального округа)";
    ...
    public function run()
    {
        ...
        $report->setExcelPatternName('Hot_pSector.xlsx');
