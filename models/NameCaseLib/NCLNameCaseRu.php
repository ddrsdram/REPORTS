 ...
 * @package NameCaseLib
 */
class NCLNameCaseRu extends NCL\NCLNameCaseCore
{
...
//Проверяем действительно ли отчество
     ...
     * @param NCL\NCLNameCaseWord $word обьект класса слов, для которого нужно определить пол
     */
    protected function GenderByFirstName(NCL\NCLNameCaseWord $word)
    {
     ...
     * @param NCL\NCLNameCaseWord $word обьект класса слов, для которого нужно определить пол
     */
    protected function GenderBySecondName(NCL\NCLNameCaseWord $word)
    {
        $this->setWorkingWord($word->getWord());
     ...
     * @param NCL\NCLNameCaseWord $word обьект класса слов, для которого нужно определить пол
     */
    protected function GenderByFatherName(NCL\NCLNameCaseWord $word)
    {
        $this->setWorkingWord($word->getWord());
     ...
     * - <b>S</b> - фамилия
     * - <b>F</b> - отчество
     * @param NCL\NCLNameCaseWord $word обьект класса слов, который необходимо идентифицировать
     */
    protected function detectNamePart(NCL\NCLNameCaseWord $word)
    {
        $namepart = $word->getWord();
        $length = NCL\NCLStr::strlen($namepart);
